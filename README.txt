...
Working with API:
     ...
     - To get the result of converting one currency to another: BASE-URL/currency/convert/BASE-CURRENCY/TARGET-CURRENCY/QUANTITY
...
Работа с API:
    ...
    - Для получения результата конвертации одной валюты в другую: BASE-URL/currency/convert/BASE-CURRENCY/TARGET-CURRENCY/QUANTITY
